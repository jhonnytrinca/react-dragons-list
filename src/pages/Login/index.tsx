...
const Login = () => {
  ...
  return (
    <FormikProvider value={formik}>
      <div className='flex w-screen h-screen overflow-hidden relative lg:justify-end'>
        ...
        <div className='w-full lg:w-3/5 lg:px-32 py-14 sm:py-0 flex flex-col gap-12 sm:justify-center items-center z-10'>
          <div className='w-4/5 lg:w-2/3'>
            <p className='w-4/5 text-4xl sm:text-7xl text-blue-600 font-poppins'>
              React Dragons List.
            </p>
          </div>
          <div className='flex flex-col gap-8 items-center w-4/5 lg:w-2/3'>
            ...
            <Button
              ...
              className='w-full text-white py-2 rounded-md bg-blue-700 hover:enabled:bg-blue-500 disabled:opacity-60 transition-colors '
            >
              Entrar
            </Button>
            <p className='w-full flex justify-center text-gray-500 gap-2 bg-white rounded px-4 py-2'>
              Não possui conta?
              <Button
